...
export default function Ref({ deckReference, extraClasses }: { deckReference: any, extraClasses: string }) {
    ...
    if (deckReference) {
        ...
        <div class={extraClasses} key={ id }>
            ...
            {annotation && expanded && <div class="ref-scribble pigment-fg-{ resource }">{ annotation }</div>}
        </div>);
    } else {
        return <div></div>
    }
