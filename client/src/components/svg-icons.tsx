...
export function svgCircle(extraClasses: string) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
...
export function svgFilledCircle(extraClasses: string) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
...
export function svgReviewCards(extraClasses: string) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            width="24"
        >
            <path xmlns="http://www.w3.org/2000/svg" d="M9 11.5C9.55228 11.5 10 11.0523 10 10.5C10 9.94772 9.55228 9.5 9 9.5C8.44772 9.5 8 9.94772 8 10.5C8 11.0523 8.44772 11.5 9 11.5Z" class={extraClasses}></path>
            <path xmlns="http://www.w3.org/2000/svg" d="M11 10.5C11 9.94772 11.4477 9.5 12 9.5H15C15.5523 9.5 16 9.94772 16 10.5C16 11.0523 15.5523 11.5 15 11.5H12C11.4477 11.5 11 11.0523 11 10.5Z" class={extraClasses}></path>
            <path xmlns="http://www.w3.org/2000/svg" d="M12 12.5C11.4477 12.5 11 12.9477 11 13.5C11 14.0523 11.4477 14.5 12 14.5H15C15.5523 14.5 16 14.0523 16 13.5C16 12.9477 15.5523 12.5 15 12.5H12Z" class={extraClasses}></path>
            <path xmlns="http://www.w3.org/2000/svg" d="M12 15.5C11.4477 15.5 11 15.9477 11 16.5C11 17.0523 11.4477 17.5 12 17.5H15C15.5523 17.5 16 17.0523 16 16.5C16 15.9477 15.5523 15.5 15 15.5H12Z" class={extraClasses}></path>
            <path xmlns="http://www.w3.org/2000/svg" d="M10 13.5C10 14.0523 9.55228 14.5 9 14.5C8.44772 14.5 8 14.0523 8 13.5C8 12.9477 8.44772 12.5 9 12.5C9.55228 12.5 10 12.9477 10 13.5Z" class={extraClasses}></path>
            <path xmlns="http://www.w3.org/2000/svg" d="M9 17.5C9.55228 17.5 10 17.0523 10 16.5C10 15.9477 9.55228 15.5 9 15.5C8.44772 15.5 8 15.9477 8 16.5C8 17.0523 8.44772 17.5 9 17.5Z" class={extraClasses}></path>
            <path xmlns="http://www.w3.org/2000/svg" d="M9 2C8.44772 2 8 2.44772 8 3H6C4.89543 3 4 3.89543 4 5V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V5C20 3.89543 19.1046 3 18 3H16C16 2.44772 15.5523 2 15 2H9ZM16 5H18V20H6V5H8V6C8 6.55228 8.44772 7 9 7H15C15.5523 7 16 6.55228 16 6V5ZM10 5V4H14V5H10Z" class={extraClasses}></path>
        </svg>
    );
}
    ...
    return (
        ...
        >
            <path
                ...
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M 12 4 C 12.5523 4 13 4.4477 13 5 V 11 H 19 C 19.5523 11 20 11.4477 20 12 C 20 12.5523 19.5523 13 19 13 H 13 V 19 C 13 19.5523 12.5523 20 12 20 C 11.4477 20 11 19.5523 11 19 V 13 H 5 C 4.4477 13 4 12.5523 4 12 C 4 11.4477 4.4477 11 5 11 H 11 V 5 C 11 4.4477 11.4477 4 12 4 Z"
                class="svg-fill-colour"
            ></path>
        </svg>
    );
...
export function svgMinimise() {
    return (
        ...
        >
            <path
                xmlns="http://www.w3.org/2000/svg"
                d="m 4 12 c 0 -0.5523 0.4477 -1 1 -1 h 14 c 0.5523 0 1 0.4477 1 1 s -0.4477 1 -1 1 h -14 c -0.5523 0 -1 -0.4477 -1 -1 z"
                class="svg-fill-colour"
            ></path>
        </svg>
    );
