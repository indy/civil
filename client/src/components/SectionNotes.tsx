...
import { NoteSection,
         NOTE_KIND_NOTE, NOTE_KIND_SUMMARY, NOTE_KIND_REVIEW} from './NoteSection';

export default function SectionNotes({ deck, onRefsChanged, title, resource, howToShowNoteSection, canShowNoteSection, onUpdateDeck, noappend }: { deck?: any, onRefsChanged?: any, title?: any, resource?: any, howToShowNoteSection?: any, canShowNoteSection?: any, onUpdateDeck?: any, noappend?: any }) {
