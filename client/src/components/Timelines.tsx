...
import { svgPointAdd, svgX, svgCaretRight, svgCaretRightEmpty, svgCaretDown } from '../svgIcons';
...
<SectionUpdateTimeline timeline={ deck } onUpdate={ deckManager.updateAndReset }/>
        ...
        { !!deck && <ListPoints points={ deck.points }
...
function TimelineDeckPoint({ deckPoint, hasNotes, noteManager, holderId }: { deckPoint?: any, hasNotes?: any, noteManager?: any, holderId?: any }) {
...
function ListPoints({ points, deckManager, holderId, holderName, showAddPointForm }: { points?: any, deckManager?: any, holderId?: any, holderName?: any, showAddPointForm?: any }) {
