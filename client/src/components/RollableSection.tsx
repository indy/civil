...
export default function RollableSection({ heading, children, initiallyRolledUp }: { heading?: any, children?: any, initiallyRolledUp?: any }) {
    ...
    return (<section class={classState}>
        <div>
