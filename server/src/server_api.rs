    ...
    scope(mount_point)
        ...
        .service(
            scope("/decks")
                ...
                .route("/insignias", get().to(decks::insignias))
        ...
        .service(
            scope("/concepts")
                .route("", post().to(concepts::create))
                .route("", get().to(concepts::get_all))
                .route("/pagination", get().to(concepts::pagination))
